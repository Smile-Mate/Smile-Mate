...
export default function AvatarRabbit2({ blendshapes, rotation }: { blendshapes: any[]; rotation: Euler | null }) {
  const { scene } = useGLTF('/characters/rabbit/rigged_rabbit_vtuber_with_facial_blendshape.glb');
  ...
  return <primitive object={scene} position={[0, -3, 0]} scale={[0.5, 0.5, 0.5]} />;
